 ...
 */
namespace FireBase\PhpJwt\Authentication;
require_once VENDOR_PATH . '/firebase/php-jwt/Exceptions/BeforeValidException.php';
require_once VENDOR_PATH . '/firebase/php-jwt/Exceptions/ExpiredException.php';
require_once VENDOR_PATH . '/firebase/php-jwt/Exceptions/SignatureInvalidException.php';
use FireBase\PhpJwt\Exceptions\SignatureInvalidException;
use FireBase\PhpJwt\Exceptions\ExpiredException;
use FireBase\PhpJwt\Exceptions\BeforeValidException;
class JWT
{
