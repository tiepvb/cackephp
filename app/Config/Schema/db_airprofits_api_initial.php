<?php
class DbAirprofitsApiInitialSchema extends CakeSchema
{
    public $users = array(
        ...
        'indexes'       => array(
            ...
            'username_UNIQUE' => array('column' => 'name', 'unique' => 1)
        ),
    ...
    public $listings = array(
        ...
        'status'            => array('type' => 'tinyinteger', 'null' => false, 'default' => 0, 'length' => 1),
    ...
    public $prices = array(
        ...
        'year'  => array('type' => 'varchar', 'null' => true, 'length' => 4),
        'month'  => array('type' => 'varchar', 'null' => true, 'length' => 2),
        'day'  => array('type' => 'varchar', 'null' => true, 'length' => 2),
        'native_offer'     => array('type' => 'float', 'null' => false, 'default' => 0.00),
        'native_currency'  => array('type' => 'varchar', 'null' => true, 'length' => 3),
        'created'           => array('type' => 'datetime', 'null' => true, 'default' => null),
        'modified'          => array('type' => 'datetime', 'null' => true, 'default' => null),
        'indexes'       => array(
            'PRIMARY'   =>  array('column' => 'id', 'unique' => 1),
    ...
    public $sales = array(
        ...
        'type' => array('type' => 'tinyinteger', 'null' => false, 'default' => 0, 'length' => 1),
